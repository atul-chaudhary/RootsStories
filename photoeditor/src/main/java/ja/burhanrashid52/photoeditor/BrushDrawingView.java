...
public class BrushDrawingView extends View {
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        Log.d("atulLog", "Yoo onSizeChangedVI: "+BrushDrawingView.this.getWidth()+"    "+BrushDrawingView.this.getHeight());
        Log.d("atulLog", "Yoo onSizeChangedVI: "+BrushDrawingView.this.getMeasuredWidth()+"    "+BrushDrawingView.this.getMeasuredHeight());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            Log.d("atulLog", "Yoo onSizeChangedVI: "+BrushDrawingView.this.getMinimumHeight()+"    "+BrushDrawingView.this.getMinimumHeight());
        }
    }
    ...
    protected void onSizeChanged(final int w, final int h, final int oldw, final int oldh) {
        ...
        Log.d("atulLog", "onSizeChanged: "+w+"    "+h);
        Log.d("atulLog", "onSizeChanged: IOI>> "+width+"    "+height);
        if (width>0&&height>0) {
